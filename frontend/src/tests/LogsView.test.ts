...
describe('LogsView', () => {
  ...
  beforeEach(() => {
    ...
    toLocaleTimeStringSpy.mockReturnValue('15:01:00')
    toLocaleStringSpy.mockReturnValue('20/03/2026, 15:00:00')
  })
  ...
  it('renderiza logs agregados e inicia polling', () => {
    ...
    expect(toLocaleTimeStringSpy).toHaveBeenCalledWith('pt-BR')
    expect(toLocaleStringSpy).toHaveBeenCalledWith('pt-BR')
  })
})
